              ...
              <DropdownMenuContent>
                <DropdownMenuCheckboxItem
                  ...
                  onCheckedChange={(checked) =>
                    setStatusFilter(checked
                      ? [...statusFilter, 'active']
                      : statusFilter.filter((item) => item !== 'active')
                    )
                  }
                >
                  Active
                ...
                <DropdownMenuCheckboxItem
                  ...
                  onCheckedChange={(checked) =>
                    setStatusFilter(checked
                      ? [...statusFilter, 'close']
                      : statusFilter.filter((item) => item !== 'close')
                    )
                  }
                >
                  Close
              ...
              {filteredAndSortedProjects.map((project) => (
                <TableRow key={project.project_id}>
                  <TableCell className="font-medium">
                    <Link href={`/projects/project-detail?id=${project.project_id}`} className="text-blue-600 hover:underline">
