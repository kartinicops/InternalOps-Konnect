  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const expertResponse = await API.post("/experts/", {
        ...
        expert_cost: formData.expertCost || null,  // Use null if expertCost is empty
      ...
      if (error.response) {
        // Cek apakah error terkait email duplikat
    ...
    <div className="relative z-10 space-y-4">
      {careerEntries.length === 0 ? (
        ...
        careerEntries.map((entry, index) => (
          <div key={index} className="border border-gray-200 bg-white/80 backdrop-blur-sm rounded-lg p-4 space-y-4 hover:border-blue-400 transition-colors shadow-sm hover:shadow-md">
